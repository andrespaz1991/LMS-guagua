...
$horarios= ($academico->consultar_horario_simple($_GET['asignacion'])[0]);
?>
...
<a href="<?php echo SGA_CURSOS_URL ?>/edunotas.php?asignacion=<?php echo $asignacion; ?>" style="position:absolute;margin-left:80%;margin-top:8%" class="btn btn-primary" href="">Nueva Nota</a>
...
$todas=$planeacion->mostrar_todas_planeaciones($id_materia,$nombre_grado);
if(!empty($todas)){
?>
...
$contador=0;
 foreach ($todas as $planes => $plan) { 
  ...
  <tr>
    ...
    <td><?php echo  Comun::remover_ultimo_caracter($planeacion->contenido_plan); ?></td>
    <td><?php echo  Comun::remover_ultimo_caracter($planeacion->objetivos_plan) ; ?></td>
    <td><?php echo  Comun::remover_ultimo_caracter($planeacion->estrategiaa) ; ?></td>
    ...
    <td><a class="btn btn-success" href="<?php echo SGA_PLANEADOR_URL ?>/index.php?id=<?php echo $planeacion->id_plan ?>&asignacion=<?php echo $_GET['asignacion'] ?>">Editar</a><br/><br/>
<a class="btn btn-warning" href="<?php echo SGA_PLANEADOR_URL ?>/duplicar_plan.php?id=<?php echo $planeacion->id_plan ?>&asignacion=<?php echo $_GET['asignacion'] ?>">Duplicar</a>
    ...
    <td><a class="btn btn-primary" href="<?php echo SGA_PLANEADOR_URL ?>/reporte.php?idplan=<?php echo $planeacion->id_plan ?>">Descargar</a>

<a target="_blank" href="<?php echo SGA_PLANEADOR_URL ?>/reporte_todos.php?id_plan=<?php echo $plan[0]; ?>">
