...
class Clase_mysqli extends Comun{
    ...
    private $servidorbd = "sql304.epizy.com";
    private $usuariobd = "epiz_30530559";
    private $clavebd = "xAkXq1xo1XyFhE";
    private $basededatos = "epiz_30530559_guagua";
    private $con;
...
public function conectar(){
   ...
   $conexion_mysqli = new mysqli ($this->servidorbd,$this->usuariobd,$this->clavebd,$this->basededatos,'3306');
