...
<input class="hidden-print" type="submit" onclick="" name="imprimir" value="Imprimir">
</a>
...
<th> <form target="_blank" action="../../asistencia/control_ingreso.php">
