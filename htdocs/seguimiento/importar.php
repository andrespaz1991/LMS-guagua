...
if (($archivo_abierto = fopen($archivo, "r")) !== FALSE) { 
	while ($celdas = fgetcsv ($archivo_abierto,2000, ";")){
		$persona=new Persona($celdas[0]);
		echo $celdas[0]." persona eliminada ".$persona->eliminar_persona().'<br>';	
	}
}
...
####function para borrar registros 

####### fin función para borrar registros
