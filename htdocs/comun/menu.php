...
<?php if(!empty($institucion) and !empty($_SESSION['institucion'])){
require_once dirname(__FILE__)."/autoload.php";
$institucion=new Institucion($_SESSION['institucion']);
 ?>
  <img  style="margin-left:40px;margin-top:6%" height="60" src="
    <?php echo  SGA_COMUN_SGA_DATA.'/'.$institucion->logo_institucion; ?>" ></img>
    <?php } ?>
  </a>
  </div>
...
<ul class="dropdown-menu">
  ...
  <li><a href="<?php echo SGA_PLANEADOR_URL ?>/institucion_educativa.php">Ajustes de la Institución</a></li>
   <li><a href="<?php echo SGA_URL ?>/planeador/materia.php">Materias</a></li>
      <li><a href="<?php echo SGA_URL ?>/planeador/actividad.php">Actividades de planeación</a></li>
       <li><a href="<?php echo SGA_URL ?>/planeador/Estrategias.php">Estrategias de planeación</a></li>
       <li><a href="<?php echo SGA_URL ?>/planeador/contenido.php">Contenido de planeación</a></li>
       <li><a href="<?php echo SGA_URL ?>/planeador/objetivos.php">Objetivos de planeación</a></li>
   <li><a href="<?php echo SGA_URL ?>/evaldocente/php/asignacion.php">Asignación</a></li>
